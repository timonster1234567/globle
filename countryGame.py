...
countries =    [["Andorra", 1.601554, 42.546245],
...
randcountry = countries[random.randint(0, 249)][0]
print(randcountry)

countryradians = countries
for countryset in countryradians:
...
def distance(country1, country2):
    ...
    for country in range(len(countryradians)):
        if(countryradians[country][0] == country1):
            country1longitude = countryradians[country][2]
            country1latitude = countryradians[country][1]
        if(countryradians[country][0] == country2):
            country2longitude = countryradians[country][2]
            country2latitude = countryradians[country][1]

    latitudedifference = float(country1latitude) - float(country2latitude)
    longitudedifference = float(country1longitude) - float(country2longitude)
    # print(country1latitude)
    ...
    if d == 0:
        ...
        print("About " + str(d) + " kilometers away.")
# print(countryradians)
while play == True:
    guess = input("Guess a country: ")
    works = False
    for j in range(len(countryradians)):
        if guess.upper() == countryradians[j][0].upper():
            works = True
    if works == False:
